/**
 * Anime Animation
 * WebGL ASCII visualization for the anime section
 */
    ...
    const animate = () => {
      ...
      for (let y = 0; y < this.height; y++) {
        for (let x = 0; x < this.width; x++) {
          // Create a simple wave pattern with noise (offset by index 1)
          const wave = Math.sin(x * 0.1 + time + 1) * 0.5 + 0.5;
          const noise = Math.sin(y * 0.2 + time * 0.5 + 2) * 0.5 + 0.5;
